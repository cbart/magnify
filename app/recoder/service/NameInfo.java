...
public interface NameInfo extends Service {
    ...
    /**
     * Returns a package represented by the given fully qualified name. If the
     * package has not been encountered before, a new package is created and
     * returned.
     * 
     * @param name
     *            a qualified name.
    ...
    /**
     * Returns the package represented by the given fully qualified name, if it
     * already exists.
     * 
     * @param name
     *            a qualified name.
    ...
    /**
     * Returns the type represented by the given fully qualified name. If the
     * type is currently not available, the method returns <tt>null</tt>. A
     * type may be unavailable either if it currently has not been analyzed or
     * is undefined. The specific behavior depends on the compiler
     * configuration.
     * <br><br>
     * As of 0.90, this method can be used to obtain ParameterizedTypes. These
     * types are not registered internally to be returned by <code>getTypes()</code>.
     * <tt>null</tt> is returned even if just one of the TypeArguments cannot be
     * resolved.
     * <br><br>
     * Further, as of 0.90, types from <code>java.lang.</code> are automatically
     * found. I.e., it is now possible to just call <code>getType("String"></code>
     * to get java.lang.String.
     * 
     * @param name
     *            a fully qualified type name, possibly with type arguments.
     ...
     * @since 0.91
     */
    List<ClassType> getClassTypes(String pattern);
    
    /**
     * @TODO document
     * @param pattern
     * @return <code>getMethods(pattern,false)</code>
     * @since 0.91
     */
     ...
     * @since 0.95
     */
    List<Method> getMethods(String pattern, boolean includeConstructors);
    ...
    /**
     * Returns the class type represented by the given fully qualified name. If
     * the type is currently not available or does not represent a class type,
    ...
    /**
     * Returns the array type for the given base type. This method will create
     * one if needed.
     * Same as <code>createArrayType(basetype, 1)</code>
     * 
     * @param basetype
     *            the base type to find an array type for.
    ...
    /**
     * Returns the predefined Null type. The Null type is widening to each class
     * or array type.
     * 
    ...
    /**
     * Returns the predefined Class type. The Class type appears as the type of
     * ".class" references.
     * 
    ...
    /**
     * Returns the predefined Cloneable type. The Cloneable type is a valid
     * supertype of arrays.
     * 
    ...
    /**
     * Returns the predefined Serializable type. The Serializable type is a
     * valid supertype of arrays.
     * 
    ...
    /**
     * Returns the placeholder for an unknown entity that might be a package,
     * class type, or field. Unknown elements can model incomplete programs.
     ...
     * information about single unknown elements. As the alias problem is not
     * solvable, there is only one representative for all unknown elements of a
     * certain type.
     */
    ProgramModelElement getUnknownElement();

    /**
     * Returns the placeholder for an unknown type. Unknown elements can model
     * incomplete programs. Queries for properties of unknown elements will
     * return only minimum information, even though it often is possible to
     * infer certain information about single unknown elements. As the alias
     * problem is not solvable, there is only one representative for all unknown
     * elements of a certain type.
     */
    Type getUnknownType();

    /**
     * Returns the placeholder for an unknown class type. Unknown elements can
     * model incomplete programs. Queries for properties of unknown elements
     * will return only minimum information, even though it often is possible to
     * infer certain information about single unknown elements. As the alias
     * problem is not solvable, there is only one representative for all unknown
     * elements of a certain type.
     */
    ...
    /**
     * Returns the placeholder for an unknown package. Unknown elements can
     * model incomplete programs. Queries for properties of unknown elements
     * will return only minimum information, even though it often is possible to
     * infer certain information about single unknown elements. As the alias
     * problem is not solvable, there is only one representative for all unknown
    ...
    /**
     * Returns the placeholder for an unknown method. Unknown elements can model
     * incomplete programs. Queries for properties of unknown elements will
     * return only minimum information, even though it often is possible to
     * infer certain information about single unknown elements. As the alias
     * problem is not solvable, there is only one representative for all unknown
    ...
    /**
     * Returns the placeholder for an unknown constructor. Unknown elements can
     * model incomplete programs. Queries for properties of unknown elements
     * will return only minimum information, even though it often is possible to
     * infer certain information about single unknown elements. As the alias
     * problem is not solvable, there is only one representative for all unknown
    ...
    /**
     * Returns the placeholder for an unknown variable. Unknown elements can
     * model incomplete programs. Queries for properties of unknown elements
     * will return only minimum information, even though it often is possible to
     * infer certain information about single unknown elements. As the alias
     * problem is not solvable, there is only one representative for all unknown
    ...
    /**
     * Returns the placeholder for an unknown field. Unknown elements can model
     * incomplete programs. Queries for properties of unknown elements will
     * return only minimum information, even though it often is possible to
     * infer certain information about single unknown elements. As the alias
     * problem is not solvable, there is only one representative for all unknown
